...
int sha3_224_update(register keccak_sponge* const restrict sponge,
                  register const uint8_t* const restrict in,
                  register const size_t inlen) {
  do { if (sponge == ((void *)0)) { do { fprintf(__stderrp, "%s:%u: hard rte: %s\n", "<stdin>", 2870, err_ptrnull); return errno_ptrnull; } while (0); } } while (0);
  do { if (in == ((void *)0)) { do { fprintf(__stderrp, "%s:%u: hard rte: %s\n", "<stdin>", 2871, err_ptrnull); return errno_ptrnull; } while (0); } } while (0);
  int err = _hash_update(sponge, in, inlen, flag_sha3_224 ^ hash_absorbing);
  do { if (err == 0) { break; } else { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 2874, err_sha3); return errno_sha3; } while (0); } } while (0);
  return 0;
}
int sha3_224_digest(register keccak_sponge* const restrict sponge,
                  register uint8_t* const restrict out,
                  register const size_t outlen) {
  do { if (outlen != 28) { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 2898, err_digestlen); return errno_digestlen; } while (0); } } while (0);
  do { if (sponge == ((void *)0)) { do { fprintf(__stderrp, "%s:%u: hard rte: %s\n", "<stdin>", 2899, err_ptrnull); return errno_ptrnull; } while (0); } } while (0);
  do { if (out == ((void *)0)) { do { fprintf(__stderrp, "%s:%u: hard rte: %s\n", "<stdin>", 2900, err_ptrnull); return errno_ptrnull; } while (0); } } while (0);
  int err = _hash_finalize(
      sponge, pad_sha, flag_sha3_224 ^ hash_absorbing, flag_sha3_224 ^ hash_squeezing);
  do { if (err == 0) { break; } else { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 2905, err_sha3); return errno_sha3; } while (0); } } while (0);
  memclear((uint8_t*)sponge->a + 64, 200 - 64);
  err = _hash_squeeze(sponge, out, 28, flag_sha3_224 ^ hash_squeezing);
  state_scribble(sponge);
  do { if (err == 0) { break; } else { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 2914, err_sha3); return errno_sha3; } while (0); } } while (0);
  return 0;
}
int sha3_224(register uint8_t* const restrict out,
           register const size_t outlen,
           register const uint8_t* const restrict in,
           register const size_t inlen) {
  do { if (out == ((void *)0)) { do { fprintf(__stderrp, "%s:%u: hard rte: %s\n", "<stdin>", 2937, err_ptrnull); return errno_ptrnull; } while (0); } } while (0);
  do { if (in == ((void *)0)) { do { fprintf(__stderrp, "%s:%u: hard rte: %s\n", "<stdin>", 2938, err_ptrnull); return errno_ptrnull; } while (0); } } while (0);
  do { if (outlen != 28) { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 2939, err_digestlen); return errno_digestlen; } while (0); } } while (0);
  keccak_sponge sponge;
  int err = 0;
  err = sha3_224_init(&sponge);
  do { if (err == 0) { break; } else { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 2944, err_sha3); return errno_sha3; } while (0); } } while (0);
  err = sha3_224_update(&sponge, in, inlen);
  do { if (err == 0) { break; } else { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 2946, err_sha3); return errno_sha3; } while (0); } } while (0);
  err = sha3_224_digest(&sponge, out, outlen);
  do { if (err == 0) { break; } else { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 2948, err_sha3); return errno_sha3; } while (0); } } while (0);
  memclear(&sponge, sizeof(sponge));
  return err;
}
int sha3_256_init(register keccak_sponge* const restrict sponge) {
  do { if (sponge == ((void *)0)) { do { fprintf(__stderrp, "%s:%u: hard rte: %s\n", "<stdin>", 2995, err_ptrnull); return errno_ptrnull; } while (0); } } while (0);
  int err = _hash_init(sponge, 200 - (32 * 2), flag_sha3_256 ^ hash_absorbing);
  do { if (err == 0) { break; } else { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 2998, err_sha3); return errno_sha3; } while (0); } } while (0);
  return 0;
}
int sha3_256_update(register keccak_sponge* const restrict sponge,
                  register const uint8_t* const restrict in,
                  register const size_t inlen) {
  do { if (sponge == ((void *)0)) { do { fprintf(__stderrp, "%s:%u: hard rte: %s\n", "<stdin>", 3023, err_ptrnull); return errno_ptrnull; } while (0); } } while (0);
  do { if (in == ((void *)0)) { do { fprintf(__stderrp, "%s:%u: hard rte: %s\n", "<stdin>", 3024, err_ptrnull); return errno_ptrnull; } while (0); } } while (0);
  int err = _hash_update(sponge, in, inlen, flag_sha3_256 ^ hash_absorbing);
  do { if (err == 0) { break; } else { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 3027, err_sha3); return errno_sha3; } while (0); } } while (0);
  return 0;
}
int sha3_256_digest(register keccak_sponge* const restrict sponge,
                  register uint8_t* const restrict out,
                  register const size_t outlen) {
  do { if (outlen != 32) { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 3051, err_digestlen); return errno_digestlen; } while (0); } } while (0);
  do { if (sponge == ((void *)0)) { do { fprintf(__stderrp, "%s:%u: hard rte: %s\n", "<stdin>", 3052, err_ptrnull); return errno_ptrnull; } while (0); } } while (0);
  do { if (out == ((void *)0)) { do { fprintf(__stderrp, "%s:%u: hard rte: %s\n", "<stdin>", 3053, err_ptrnull); return errno_ptrnull; } while (0); } } while (0);
  int err = _hash_finalize(
      sponge, pad_sha, flag_sha3_256 ^ hash_absorbing, flag_sha3_256 ^ hash_squeezing);
  do { if (err == 0) { break; } else { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 3058, err_sha3); return errno_sha3; } while (0); } } while (0);
  memclear((uint8_t*)sponge->a + 64, 200 - 64);
  err = _hash_squeeze(sponge, out, 32, flag_sha3_256 ^ hash_squeezing);
  state_scribble(sponge);
  do { if (err == 0) { break; } else { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 3067, err_sha3); return errno_sha3; } while (0); } } while (0);
  return 0;
}
int sha3_256(register uint8_t* const restrict out,
           register const size_t outlen,
           register const uint8_t* const restrict in,
           register const size_t inlen) {
  do { if (out == ((void *)0)) { do { fprintf(__stderrp, "%s:%u: hard rte: %s\n", "<stdin>", 3090, err_ptrnull); return errno_ptrnull; } while (0); } } while (0);
  do { if (in == ((void *)0)) { do { fprintf(__stderrp, "%s:%u: hard rte: %s\n", "<stdin>", 3091, err_ptrnull); return errno_ptrnull; } while (0); } } while (0);
  do { if (outlen != 32) { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 3092, err_digestlen); return errno_digestlen; } while (0); } } while (0);
  keccak_sponge sponge;
  int err = 0;
  err = sha3_256_init(&sponge);
  do { if (err == 0) { break; } else { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 3097, err_sha3); return errno_sha3; } while (0); } } while (0);
  err = sha3_256_update(&sponge, in, inlen);
  do { if (err == 0) { break; } else { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 3099, err_sha3); return errno_sha3; } while (0); } } while (0);
  err = sha3_256_digest(&sponge, out, outlen);
  do { if (err == 0) { break; } else { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 3101, err_sha3); return errno_sha3; } while (0); } } while (0);
  memclear(&sponge, sizeof(sponge));
  return err;
}
int sha3_384_init(register keccak_sponge* const restrict sponge) {
  do { if (sponge == ((void *)0)) { do { fprintf(__stderrp, "%s:%u: hard rte: %s\n", "<stdin>", 3148, err_ptrnull); return errno_ptrnull; } while (0); } } while (0);
  int err = _hash_init(sponge, 200 - (48 * 2), flag_sha3_384 ^ hash_absorbing);
  do { if (err == 0) { break; } else { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 3151, err_sha3); return errno_sha3; } while (0); } } while (0);
  return 0;
}
int sha3_384_update(register keccak_sponge* const restrict sponge,
                  register const uint8_t* const restrict in,
                  register const size_t inlen) {
  do { if (sponge == ((void *)0)) { do { fprintf(__stderrp, "%s:%u: hard rte: %s\n", "<stdin>", 3176, err_ptrnull); return errno_ptrnull; } while (0); } } while (0);
  do { if (in == ((void *)0)) { do { fprintf(__stderrp, "%s:%u: hard rte: %s\n", "<stdin>", 3177, err_ptrnull); return errno_ptrnull; } while (0); } } while (0);
  int err = _hash_update(sponge, in, inlen, flag_sha3_384 ^ hash_absorbing);
  do { if (err == 0) { break; } else { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 3180, err_sha3); return errno_sha3; } while (0); } } while (0);
  return 0;
}
int sha3_384_digest(register keccak_sponge* const restrict sponge,
                  register uint8_t* const restrict out,
                  register const size_t outlen) {
  do { if (outlen != 48) { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 3204, err_digestlen); return errno_digestlen; } while (0); } } while (0);
  do { if (sponge == ((void *)0)) { do { fprintf(__stderrp, "%s:%u: hard rte: %s\n", "<stdin>", 3205, err_ptrnull); return errno_ptrnull; } while (0); } } while (0);
  do { if (out == ((void *)0)) { do { fprintf(__stderrp, "%s:%u: hard rte: %s\n", "<stdin>", 3206, err_ptrnull); return errno_ptrnull; } while (0); } } while (0);
  int err = _hash_finalize(
      sponge, pad_sha, flag_sha3_384 ^ hash_absorbing, flag_sha3_384 ^ hash_squeezing);
  do { if (err == 0) { break; } else { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 3211, err_sha3); return errno_sha3; } while (0); } } while (0);
  memclear((uint8_t*)sponge->a + 64, 200 - 64);
  err = _hash_squeeze(sponge, out, 48, flag_sha3_384 ^ hash_squeezing);
  state_scribble(sponge);
  do { if (err == 0) { break; } else { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 3220, err_sha3); return errno_sha3; } while (0); } } while (0);
  return 0;
}
int sha3_384(register uint8_t* const restrict out,
           register const size_t outlen,
           register const uint8_t* const restrict in,
           register const size_t inlen) {
  do { if (out == ((void *)0)) { do { fprintf(__stderrp, "%s:%u: hard rte: %s\n", "<stdin>", 3243, err_ptrnull); return errno_ptrnull; } while (0); } } while (0);
  do { if (in == ((void *)0)) { do { fprintf(__stderrp, "%s:%u: hard rte: %s\n", "<stdin>", 3244, err_ptrnull); return errno_ptrnull; } while (0); } } while (0);
  do { if (outlen != 48) { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 3245, err_digestlen); return errno_digestlen; } while (0); } } while (0);
  keccak_sponge sponge;
  int err = 0;
  err = sha3_384_init(&sponge);
  do { if (err == 0) { break; } else { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 3250, err_sha3); return errno_sha3; } while (0); } } while (0);
  err = sha3_384_update(&sponge, in, inlen);
  do { if (err == 0) { break; } else { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 3252, err_sha3); return errno_sha3; } while (0); } } while (0);
  err = sha3_384_digest(&sponge, out, outlen);
  do { if (err == 0) { break; } else { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 3254, err_sha3); return errno_sha3; } while (0); } } while (0);
  memclear(&sponge, sizeof(sponge));
  return err;
}
int sha3_512_init(register keccak_sponge* const restrict sponge) {
  do { if (sponge == ((void *)0)) { do { fprintf(__stderrp, "%s:%u: hard rte: %s\n", "<stdin>", 3301, err_ptrnull); return errno_ptrnull; } while (0); } } while (0);
  int err = _hash_init(sponge, 200 - (64 * 2), flag_sha3_512 ^ hash_absorbing);
  do { if (err == 0) { break; } else { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 3304, err_sha3); return errno_sha3; } while (0); } } while (0);
  return 0;
}
int sha3_512_update(register keccak_sponge* const restrict sponge,
                  register const uint8_t* const restrict in,
                  register const size_t inlen) {
  do { if (sponge == ((void *)0)) { do { fprintf(__stderrp, "%s:%u: hard rte: %s\n", "<stdin>", 3329, err_ptrnull); return errno_ptrnull; } while (0); } } while (0);
  do { if (in == ((void *)0)) { do { fprintf(__stderrp, "%s:%u: hard rte: %s\n", "<stdin>", 3330, err_ptrnull); return errno_ptrnull; } while (0); } } while (0);
  int err = _hash_update(sponge, in, inlen, flag_sha3_512 ^ hash_absorbing);
  do { if (err == 0) { break; } else { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 3333, err_sha3); return errno_sha3; } while (0); } } while (0);
  return 0;
}
int sha3_512_digest(register keccak_sponge* const restrict sponge,
                  register uint8_t* const restrict out,
                  register const size_t outlen) {
  do { if (outlen != 64) { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 3357, err_digestlen); return errno_digestlen; } while (0); } } while (0);
  do { if (sponge == ((void *)0)) { do { fprintf(__stderrp, "%s:%u: hard rte: %s\n", "<stdin>", 3358, err_ptrnull); return errno_ptrnull; } while (0); } } while (0);
  do { if (out == ((void *)0)) { do { fprintf(__stderrp, "%s:%u: hard rte: %s\n", "<stdin>", 3359, err_ptrnull); return errno_ptrnull; } while (0); } } while (0);
  int err = _hash_finalize(
      sponge, pad_sha, flag_sha3_512 ^ hash_absorbing, flag_sha3_512 ^ hash_squeezing);
  do { if (err == 0) { break; } else { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 3364, err_sha3); return errno_sha3; } while (0); } } while (0);
  memclear((uint8_t*)sponge->a + 64, 200 - 64);
  err = _hash_squeeze(sponge, out, 64, flag_sha3_512 ^ hash_squeezing);
  state_scribble(sponge);
  do { if (err == 0) { break; } else { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 3373, err_sha3); return errno_sha3; } while (0); } } while (0);
  return 0;
}
int sha3_512(register uint8_t* const restrict out,
           register const size_t outlen,
           register const uint8_t* const restrict in,
           register const size_t inlen) {
  do { if (out == ((void *)0)) { do { fprintf(__stderrp, "%s:%u: hard rte: %s\n", "<stdin>", 3396, err_ptrnull); return errno_ptrnull; } while (0); } } while (0);
  do { if (in == ((void *)0)) { do { fprintf(__stderrp, "%s:%u: hard rte: %s\n", "<stdin>", 3397, err_ptrnull); return errno_ptrnull; } while (0); } } while (0);
  do { if (outlen != 64) { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 3398, err_digestlen); return errno_digestlen; } while (0); } } while (0);
  keccak_sponge sponge;
  int err = 0;
  err = sha3_512_init(&sponge);
  do { if (err == 0) { break; } else { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 3403, err_sha3); return errno_sha3; } while (0); } } while (0);
  err = sha3_512_update(&sponge, in, inlen);
  do { if (err == 0) { break; } else { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 3405, err_sha3); return errno_sha3; } while (0); } } while (0);
  err = sha3_512_digest(&sponge, out, outlen);
  do { if (err == 0) { break; } else { do { fprintf(__stderrp, "%s:%u: soft rte: %s\n", "<stdin>", 3407, err_sha3); return errno_sha3; } while (0); } } while (0);
  memclear(&sponge, sizeof(sponge));
  return err;
}
